...
public class Main2 {
    ...
    public static void main(String[] args) {
        ...
        // String teste = "AAAAAAAAAAAAAAAAAAAAAAAAABBBBBBBBBBBBBBBBBBBBCCCCCCCCCCCCCCCCCCCCCCCCCDDDDDDDDDDDDDDDEEEEEEEEEEFFFFFFFFGGGGGGGGHHHHIIII";
        ...
        // System.out.println(getBinarioFormatado(100));
    }
    ...
    public static String getBinarioFormatado(String key) {
        return getBinarioFormatado(Integer.parseInt(key));
    }

    public static String getBinarioFormatado(int key) {
        String s = "" + (int) key;
    ...
    public static void imprimeNo(Heap.No no) {
        if (no.esq == null && no.dir == null) {
            texto_em_binario += "X,";
            texto_em_binario += getBinarioFormatado(Integer.toBinaryString(no.letra)) + ",";
    ...
    public static Heap.No create(int[] frequenciaLetras) {
        ...
        for (int i = 0; i < frequenciaLetras.length; i++) {
            if (frequenciaLetras[i] > 0) {
                heap.inserir(new Heap.No(frequenciaLetras[i], cod++));
                // System.out.println("------------------");
...
class Heap {
    ...
    static class No {
        ...
        public String toString() {
            ...
            // return Integer.toBinaryString(letra);
